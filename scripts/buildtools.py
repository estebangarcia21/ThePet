...
if platform.system() == "Windows":
    ...
    java_command = os.environ.get("BUILD_TOOLS_JAVA_PATH", java_command)

cmd = f'{java_command} -jar {build_tools_file} --rev {spigot_version}'
subprocess.run(cmd, cwd=build_tools_dir, shell=True)
