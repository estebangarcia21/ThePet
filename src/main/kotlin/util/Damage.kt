...
data class Weapon(val weapon: ItemStack, val name: String, val rarity: Rarity, val type: WeaponType, val attackSpeed: AttackSpeed, val damages: List<DamageId>) {
    companion object {
    ...
    fun lore(): List<String> {
        ...
        val rarityTitle = rarity.name.replaceFirstChar { if (it.isLowerCase()) it.titlecase(Locale.getDefault()) else it.toString() }
